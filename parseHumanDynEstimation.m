...
% Output:
% - parsed_dynEst: parsed human dynamics estimation vector in a Matlab struct
%
%
...
for i = 1 : numberOfJoints
    startingLinkIndex = 3 + numberOfLinks * 19 + ((i -1) * 9 + 1); % 3 instead of 2
